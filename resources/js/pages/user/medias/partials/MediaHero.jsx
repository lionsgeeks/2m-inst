                ...
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
                        <div className="relative w-full sm:w-[520px]">
                            <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center text-beta-white/70">
                                <svg
                                    viewBox="0 0 24 24"
                                    aria-hidden="true"
                                    className="h-5 w-5"
                        ...
                        {filterPills.map((pill) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={[
                                        'inline-flex items-center rounded-full px-4 py-2 text-xs font-semibold ring-1 transition focus-visible:ring-2 focus-visible:ring-beta focus-visible:ring-offset-2 focus-visible:ring-offset-alpha focus-visible:outline-none',
                                        isActive
                                            ? 'bg-beta-white text-alpha ring-beta-white/10'
                                            : 'bg-beta-white/5 text-beta-white/90 ring-beta-white/15 hover:bg-beta-white/10',
                                    ].join(' ')}
                                >
                                    {pill.label}
                                </button>
