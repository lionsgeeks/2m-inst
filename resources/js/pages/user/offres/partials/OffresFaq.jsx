function FaqItem({ title, children, defaultOpen = false }) {
    return (
        ...
        >
            ...
            <div className="border-t border-alpha/10 px-5 pt-4 pb-5 text-sm leading-6 text-so-gray">
                {children}
            </div>
        </details>
    );
    ...
    return (
        <section className="grid gap-8 lg:grid-cols-2 lg:items-start">
            <div className="grid gap-4">
                ...
                <div className="grid gap-4">
                    <FaqItem
                        title="Comment candidater à un appel d’offres ?"
                        defaultOpen
                    >
                        Consultez la fiche de l’appel d’offres, téléchargez le
                        dossier, puis suivez les instructions de dépôt (pièces,
                        formats, délais).
                    </FaqItem>
                    <FaqItem title="Où trouver les archives des AO ?">
                        La section « Archives » regroupe les appels d’offres
                        clôturés ainsi que les consultations antérieures.
                    </FaqItem>
                    <FaqItem title="Quels sont les documents généralement demandés ?">
                        En fonction du marché : pièces administratives,
                        références techniques, offres financières et
                        attestations exigées dans le dossier.
                    </FaqItem>
                </div>
            </div>
            ...
            <div className="rounded-2xl border-2 border-dashed border-gold/30 bg-gold/5 p-8 text-center ring-1 ring-gold/10">
                ...
                <p className="mt-3 text-sm leading-6 text-so-gray">
                    Contactez notre équipe achats pour toute question liée aux
                    dossiers, procédures ou accès à l’espace fournisseurs.
                </p>
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-2 text-sm text-alpha">
                        +212 5XX XX XX XX
                    </div>
                </div>
            </div>
